...
type EventHandler interface {
	...
	OnDDL(nextPos *mysql.Position, db string, table string, prefix [][]byte, suffix [][]byte, isDrop bool) error
	...
	String() string
	OnDDLAlter(mb [][]byte, db []byte) (rdb, table []byte, prefix, suffix [][]byte, err error)
...
func (h *DummyEventHandler) OnDDL(nextPos *mysql.Position, db string, table string, prefix [][]byte, suffix [][]byte, isDrop bool) error {
	return nil
}
...
func (h *DummyEventHandler) OnDDLAlter(mb [][]byte, db []byte) (rdb, table []byte, prefix, suffix [][]byte, err error) { return }
func (h *DummyEventHandler) OnDDLCreateLike(tdb, ttable []byte) (prefix, suffix [][]byte, err error) { return }
